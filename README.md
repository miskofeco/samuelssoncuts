...
- `NEXT_PUBLIC_SHOP_PHONE` and `NEXT_PUBLIC_SHOP_ADDRESS` are public legal-page contact details; booking pages use the barber-managed address and phone in Admin → Settings → Profile, defaulting to Námestie Slobody 2675, 093 01 Vranov nad Topľou and +421918531257.
