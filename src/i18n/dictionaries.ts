...
const en = {
  ...
  admin: {
    ...
    bookingContactTitle: "Booking location and contact",
    bookingContactDescription: "Shown on customers' booking details and calendar events.",
    ...
    exportSubscribeHint:
      "Subscribe once and your calendar keeps itself up to date. Use a button below, or copy the link into any calendar app. Google Calendar refreshes subscriptions every few hours.",
    exportSubscribeApple: "Add to Apple Calendar",
    exportSubscribeGoogle: "Add to Google Calendar",
    ...
    openingHoursRange: (from: string, to: string) => `Open ${from}–${to}`,
    blockedPeriodRange: (from: string, to: string) => `Blocked ${from}–${to}`,
    blockedShort: "Blocked",
    dayClosedHint: "The shop is closed on this day. Pick another date.",
    slotWhen: (day: string, time?: string) => (time ? `${day} at ${time}` : day),
    unavailableConfirmClosedTitle: "Outside opening hours",
    unavailableConfirmBlockedTitle: "Blocked time",
    unavailableConfirmClosedBody: (when: string) =>
      `${when} is outside your opening hours, so clients cannot book it. Do you still want to add a booking?`,
    unavailableConfirmBlockedBody: (when: string) =>
      `${when} is blocked, so clients cannot book it. Do you still want to add a booking?`,
    unavailableConfirmAction: "Book anyway",
    bookOutsideAvailability: "Book anyway",
    bookingOutsideHoursNotice: "outside opening hours, hidden from clients",
    bookingInBlockedTimeNotice: "in blocked time, hidden from clients",
    ...
    invalidBookingPrice: "Enter a whole amount from 0 to 10,000 €.",
    note: "Note",
    ...
    servicePrice: "Mon–Sat price (€)",
    serviceSundayPrice: "Sunday price (€)",
    serviceSundayPriceHint: "Sunday bookings use this price; gap and VIP surcharges still apply.",
    sundayPriceLabel: (price: number) => `Sun ${price} €`,
    ...
    reasonHint: (max: number) => `A few words, up to ${max} characters. Shown in your calendar.`,
  ...
  feedback: {
    ...
    checkBookingContact: "Enter a valid booking address and phone number.",
    bookingContactBarberOnly: "Only the designated barber can change booking contact details.",
    bookingContactSaved: "Booking contact details saved.",
    ...
    blockReasonRequired: "Add a short reason (2–40 characters), e.g. Holiday.",
...
const sk: Dict = {
  ...
  admin: {
    ...
    bookingContactTitle: "Miesto a kontakt rezervácií",
    bookingContactDescription: "Zobrazuje sa klientom v detaile rezervácie a v kalendári.",
    bookingAddress: "Adresa prevádzky",
    bookingPhone: "Kontaktný telefón rezervácií",
    ...
    exportSubscribeHint:
      "Kalendár odoberajte raz a bude sa aktualizovať sám. Použite tlačidlo nižšie alebo odkaz skopírujte do ľubovoľnej kalendárovej aplikácie. Google Kalendár obnovuje odbery každých pár hodín.",
    exportSubscribeApple: "Pridať do Apple Kalendára",
    exportSubscribeGoogle: "Pridať do Google Kalendára",
    ...
    openingHoursRange: (from: string, to: string) => `Otvorené ${from}–${to}`,
    blockedPeriodRange: (from: string, to: string) => `Blokované ${from}–${to}`,
    blockedShort: "Blokované",
    dayClosedHint: "V tento deň je zatvorené. Vyberte iný dátum.",
    slotWhen: (day: string, time?: string) => (time ? `${day} o ${time}` : day),
    unavailableConfirmClosedTitle: "Mimo otváracích hodín",
    unavailableConfirmBlockedTitle: "Blokovaný čas",
    unavailableConfirmClosedBody: (when: string) =>
      `${when} je mimo vašich otváracích hodín, klienti si tento čas rezervovať nemôžu. Chcete napriek tomu pridať rezerváciu?`,
    unavailableConfirmBlockedBody: (when: string) =>
      `${when} je zablokovaný čas, klienti si ho rezervovať nemôžu. Chcete napriek tomu pridať rezerváciu?`,
    unavailableConfirmAction: "Rezervovať aj tak",
    bookOutsideAvailability: "Rezervovať aj tak",
    bookingOutsideHoursNotice: "mimo otváracích hodín, klienti tento čas nevidia",
    bookingInBlockedTimeNotice: "v blokovanom čase, klienti tento čas nevidia",
    ...
    invalidBookingPrice: "Zadajte celú sumu od 0 do 10 000 €.",
    note: "Poznámka",
    ...
    servicePrice: "Cena po–so (€)",
    serviceSundayPrice: "Nedeľná cena (€)",
    serviceSundayPriceHint: "Nedeľné rezervácie používajú túto cenu; príplatky za medzeru a VIP platia aj naďalej.",
    sundayPriceLabel: (price: number) => `Ne ${price} €`,
    ...
    reasonHint: (max: number) => `Pár slov, najviac ${max} znakov. Zobrazí sa vo vašom kalendári.`,
  ...
  feedback: {
    ...
    checkBookingContact: "Zadajte platnú adresu prevádzky a telefónne číslo.",
    bookingContactBarberOnly: "Kontaktné údaje rezervácií môže meniť iba určený barber.",
    bookingContactSaved: "Kontaktné údaje rezervácií boli uložené.",
    ...
    blockReasonRequired: "Doplňte krátky dôvod (2–40 znakov), napr. Dovolenka.",
